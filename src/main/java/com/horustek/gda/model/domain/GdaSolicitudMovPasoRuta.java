 ...
 */
@Entity
@Table(name = "gda_solicitud_mov_paso_ruta")
@Getter
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id", scope = GdaSolicitudMovPasoRuta.class)
public class GdaSolicitudMovPasoRuta extends Auditable {
    @Id
    ...
    @ManyToOne
    private GdaSolicitudMovRutaAprobacion gdaSolicitudMovRutaAprobacionid;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "gdaSolicitudMovPasoRutaId")
